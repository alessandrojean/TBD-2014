...
--7-Os setores que possuem mais do que 3 funcionários (mostrar o setor e a quantidade de funcionários).

select SetorFunc,COUNT (NomeFunc) as Total_Func from Funcionarios group by SetorFunc having count(NomeFunc)>3
